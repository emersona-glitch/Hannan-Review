...
| --- | :---: |
| More than 15 git commits | yes | 22 commits, great job!
...
Your readme is boss!
The app is pretty slick and is pleasant to use given the material ui.
All features are there and intuitive to find / use.
This is some really written code, Hannan, to such a degree
that I will definitely be holding on to your project as a reference!
